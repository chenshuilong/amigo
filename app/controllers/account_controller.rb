...
class AccountController < ApplicationController
  ...
  def set_current_url
    cookies[:current_url] = request.referer unless request.referer.to_s =~ /\/login|\/logout/
  end
  ...
  def successful_authentication(user)
    ...
    back_url = cookies[:current_url] # Remember back_url
    # Valid user
    self.logged_user = user
    ...
    redirect_back_or_default(back_url || my_page_path)
  end

...
class Tracker < ActiveRecord::Base
  ...
  CORE_FIELDS_UNDISABLABLE = %w(project_id tracker_id subject description is_private).freeze
  # Fields that can be disabled
  # Other (future) fields should be appended, not inserted!
  CORE_FIELDS = %w(
    assigned_to_id category_id fixed_version_id parent_issue_id start_date due_date
    estimated_hours done_ratio mokuai_reason mokuai_name rom_version priority_id tfde_id

...
class Enumeration < ActiveRecord::Base
  ...
  validates_uniqueness_of :name, :scope => [:type, :project_id], if: -> {new_record?}
...
require_dependency 'demand_category'
require_dependency 'demand_source_category'
require_dependency 'apk_base_category'
require_dependency 'gradle_category'

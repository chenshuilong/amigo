    ...
    module Markdown
      class HTML < Redcarpet::Render::HTML
        ...
        def image(link, title, alt_text)
          return if link.nil? || !uri_with_safe_scheme?(link)
      ...
      class Formatter
        ...
        def formatter
          @@formatter ||= Redcarpet::Markdown.new(
            (Redmine::WikiFormatting::Markdown::HTML rescue (Redmine::WikiFormatting::Markdown::Formatter; Redmine::WikiFormatting::Markdown::HTML)).new(
              :filter_html => true,
              :hard_wrap => true
            ),
            :autolink => true,
